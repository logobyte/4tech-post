...
<a href="{{ route('posts.create') }}">
  <flux:button variant="primary" color="zinc">Create New</flux:button>
</a>
    ...
    <div class="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-700 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
      <article class="flex max-w-xl flex-col items-start justify-between">
        <div class="flex items-center gap-x-4 text-xs">
          ...
          <a href="#" class="relative z-10 rounded-full bg-gray-800/60 px-3 py-1.5 font-medium text-gray-300 hover:bg-gray-800">IT Department</a>
        </div>
        <div class="group relative grow">
          ...
          <p class="mt-5 line-clamp-3 text-sm/6 text-gray-400">Tell me you self</p>
        </div>
